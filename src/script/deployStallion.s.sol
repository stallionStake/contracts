...
contract DeployStallion is Script {
    ...
    function deployFantasyOracle() internal returns (address) {
        address oracle = new fantasyOracle(admin);
        console.log("Deployed Fantasy Oracle at ", oracle);
        return oracle;
    }

    function deployFantasyFactory(address _oracle) internal returns (address) {
        address factory = new fantasyFactory(admin, _oracle);
        console.log("Deployed Fantasy Factory at ", factory);
        return factory;
    }
